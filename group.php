    ...
    <div class="wrapper">
        ...
        <?php
            foreach ($group as $user) {
                echo '<div class="user'.($user["start_time"] !== null ? ' live' : '').'" data-href="https://twitch.tv/'.strtolower($user["display_name"]).'">
                    ...
                    '.($user["affiliation"] == "partner" || $user["affiliation"] == "affiliate" ? '<a href="https://twitch.tv/products/'.strtolower($creator["display_name"]).'" target="__blank" class="button no-style">Subscribe</a>' : '').'
                </div>';
            }
        ?>
        </main>
